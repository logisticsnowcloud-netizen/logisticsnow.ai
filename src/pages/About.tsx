  ...
  <div>
    ...
    <section className="py-[88px] px-[5vw] bg-bg2">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {WHY_US.map((w) => (
            <div key={w.title} className="bg-card border border-border rounded-[28px] p-8 relative overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
    ...
    <section className="py-[88px] px-[5vw] bg-background">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          <div>
            {JOURNEY.map((j, i) => (
              <div key={j.num} className="flex gap-5 pb-10 relative last:pb-0">
                {i < JOURNEY.length - 1 && (
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <div key={inv.name} className="bg-card border border-border rounded-[28px] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <div key={i} className="card-hover relative overflow-hidden !p-8">
    ...
    <div className="gradient-cta py-[100px] px-[5vw] text-center relative overflow-hidden">
      ...
      <div className="flex gap-3.5 justify-center flex-wrap relative z-[1]">
        <button className="btn-white-ln">🚛 Schedule a Free Demo →</button>
