        ...
        <ScrollReveal>
          <div className="rounded-xl border border-border bg-card p-6 md:p-10 max-w-4xl">
            ...
            <div className="mt-6 mb-6">
              <img src={supernovaAward} alt="LogisticsNow team receiving Sustainability Leaders Award at Supernova Challenge Dubai 2025" className="mx-auto w-full max-w-[82%] rounded-xl object-cover shadow-sm" />
            </div>
            <div className="mt-6">
