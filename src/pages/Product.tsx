      ...
      <section className="py-[88px] px-[5vw] bg-background">
        <div className="max-w-[1280px] mx-auto">
          ...
          {PILLARS.map((p, i) => i === activePillar && (
            <div key={i} className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-surface border border-border rounded-[28px] p-12" style={{ borderColor: `${p.color}22`, boxShadow: `0 0 60px ${p.glow}18` }}>
              <div>
      ...
      <section className="py-[88px] px-[5vw] bg-bg2">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 relative">
            ...
            {PILLARS.map((p) => (
              <div key={p.num} className="text-center px-5 relative z-[1]">
